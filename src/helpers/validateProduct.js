export const validateUpdateProduct = (req) => {
  ...
  // Extraemos los campos a validar
  ...
  if (
    ...
    return {
      error: true,
      message: "El nombre no puede estar vacío o es inválido",
    };
  }
  ...
  if (price < 0) {
    return {
      error: true,
      message: "El precio debe ser un número válido y mayor o igual a cero",
    };
  }
  ...
  if (stock < 0) {
    return {
      error: true,
      message: "El stock debe ser un número válido y mayor o igual a cero",
    };
  }
...
export const validateCreateProduct = (req) => {
  ...
  if (!brand || typeof brand !== "string" || brand.trim() === "") {
    return {
      error: true,
      message: "La marca no puede estar vacía o es inválida",
    };
  }
  if (
    !description ||
    ...
    return {
      error: true,
      message: "La descripción no puede estar vacía o es inválida",
    };
  }
  if (!image || typeof image !== "string" || image.trim() === "") {
    return {
      error: true,
      message: "La imagen no puede estar vacía o es inválida",
    };
  }
  ...
  if (price === undefined || price === null || price < 0) {
    return {
      error: true,
      message: "El precio debe ser mayor o igual a 0 o es inválido",
    };
  }
  if (stock === undefined || stock === null || stock < 0) {
    return {
      error: true,
      message: "El stock no puede ser negativo o es inválido",
    };
  }
